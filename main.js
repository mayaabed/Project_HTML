...
function search () {
  ...
  $('input').on( "change", function() {
      url = URL.createObjectURL(c[c.length-1].files[0])
      track_list.push({path:url, name:c[c.length-1].files[0].name, image:"Tracks/music.jpeg", artist:"Unknown", type:c[c.length-1].files[0].type})
})
